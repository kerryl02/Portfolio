    ...
    return (
        <section className="w-full py-10">
            <h1 className="heading">
                Ma Manière De <span className="text-purple">Procéder</span>
            </h1>
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card title="planification & stratégie" icon={<AceternityIcon order="Phase 1" />} description="">
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                        containerClassName="bg-emerald-900"
                    />
                </Card>
                <Card title="développement & mise à jour" icon={<AceternityIcon order="Phase 2"/>} description="">
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card title="développement & lancement" icon={<AceternityIcon order="Phase 3" />} description="">
                    <CanvasRevealEffect
                        animationSpeed={3}
