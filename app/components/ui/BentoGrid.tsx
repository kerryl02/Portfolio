...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid md:grid-cols-5 gap-4 max-w-7xl mx-auto",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('sodakerryl@gmail.com');
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(59,59,68,1) 26%, rgba(114,57,117,1) 100%)',
      }}
    >
